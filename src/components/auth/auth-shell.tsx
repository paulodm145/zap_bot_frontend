  ...
  return (
    <main className={styles.shell}>
      <section className={styles.brandPanel}>
        <Link href="/login" aria-label="ZapBot — início">
          <Logo />
        </Link>
        <div className={styles.pitch}>
          <span className={styles.eyebrow}>Conversas que trabalham por você</span>
          <h1>
            Automatize. Conecte. <em>Converta.</em>
          </h1>
          ...
          <div className={styles.flowPreview} aria-hidden="true">
            ...
            <div className={styles.node}>
              ...
              <div>
                ...
                <strong>Identificar intenção</strong>
              </div>
            </div>
          </div>
          <div className={styles.proof}>
            <CheckCircle2 size={18} /> Configuração simples, sem código
          </div>
        </div>
