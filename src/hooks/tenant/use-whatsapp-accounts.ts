...
export function useWhatsAppAccounts(){ return useQuery({queryKey:keys,queryFn:({signal})=>apiRequest<Page<WhatsAppAccount>>('/contas-whatsapp?skip=0&take=100',{signal})}); }
